...
describe("DataStoreAdapter", () => {
    ...
    describe("load and save", () => {
        it("should load data from storage", async () => {
            const testData: SrsData = {
                ...
                trackedFiles: [
                    new TrackedFile("test.md", RPITEMTYPE.NOTE, "default"),
                ],
            };
        ...
        it("should save data to storage", async () => {
            adapter.data.items.push(
                new RepetitionItem(1, 0, RPITEMTYPE.NOTE, "default", {}),
            );
    ...
    describe("review operations", () => {
        beforeEach(() => {
            // Initialize balance module's dueDatesDict
            const { setDueDates } = require("../../../src/algorithms/balance/balance");
            setDueDates({}, {});
        });
    ...
    describe("utility methods", () => {
        it("should get max item ID", () => {
            ...
            adapter.data.items.push(
                new RepetitionItem(5, 0, RPITEMTYPE.NOTE, "default", {}),
            );
            adapter.data.items.push(
                new RepetitionItem(3, 0, RPITEMTYPE.NOTE, "default", {}),
            );
        ...
        it("should get item size", () => {
            ...
            adapter.data.items.push(
                new RepetitionItem(2, 0, RPITEMTYPE.NOTE, "default", {}),
            );
        ...
        it("should reset data", () => {
            ...
            adapter.data.trackedFiles.push(
                new TrackedFile("test.md", RPITEMTYPE.NOTE, "default"),
            );
