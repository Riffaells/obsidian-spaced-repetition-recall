...
export default {
    ...
    SETTINGS_MODAL_SECTION_HEADER: "Заголовок",
    SETTINGS_MODAL_SECTION_MULTILINE: "Многострочные",
    SETTINGS_MODAL_SECTION_CLOZE: "Закрытые",
    RULE_NAME: "Название правила",
    RULE_NAME_PLACEHOLDER: "например, 'Мои карточки по химии'",
    TAG_MATCHER: "Фильтр тегов",
    TAG_MATCHER_DESC: "Выберите, как сопоставлять теги: точно или с помощью регулярного выражения.",
    EXACT_TAG: "Точный тег",
    REGEX_PATTERN: "Шаблон Regex",
    TAG_PLACEHOLDER: "например, #мой-тег",
    REGEX_PLACEHOLDER: "например, #теги/.*",
    PRIORITY: "Приоритет",
    PRIORITY_HINT: "Чем больше число, тем выше приоритет.",
    ENABLED: "Включено",
    SEPARATOR: "Разделитель",
    SEPARATOR_DESC_INLINE: "Текст, разделяющий вопрос и ответ.",
    REVERSED_SEPARATOR: "Обратный разделитель",
    REVERSED_SEPARATOR_DESC_INLINE: "Разделитель для карточек, где ответ идет первым.",
    HEADING_LEVELS: "Уровни заголовков",
    HEADING_LEVELS_DESC: "Выберите, с каких уровней заголовков создавать карточки.",
    ...
    PATTERNS: "Шаблоны",
    PATTERNS_DESC: "Введите один шаблон пропуска на строку. Смотрите вики для руководства.",
    CREATE: "Создать",
