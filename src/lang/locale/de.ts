...
export default {
    ...
    TODAY: "Heute",
    TOMORROW: "Morgen",
    TODAY_LATER_HOURS: "Heute (in {hours}Std)",
    TODAY_LATER_MINUTES: "Heute (in {minutes}Min)",
    ...
    CREATE_FLASHCARD_RULE: "Lernkartenregel erstellen",
    SETTINGS_MODAL_SECTION_INLINE: "Einzeilig",
    SETTINGS_MODAL_SECTION_HEADER: "Kopfzeile",
    SETTINGS_MODAL_SECTION_MULTILINE: "Mehrzeilig",
    SETTINGS_MODAL_SECTION_CLOZE: "Lückentext",
    RULE_NAME: "Regelname",
    ...
    REGEX_PLACEHOLDER: "z.B. #tags/.*",
    PRIORITY: "Priorität",
    PRIORITY_HINT: "Höhere Zahlen werden zuerst ausgeführt.",
    ENABLED: "Aktiviert",
    ...
    NESTING_MODE_NESTED: "Verschachtelt (unter übergeordneten Überschriften)",
    NESTING_MODE_FLAT: "Flach (auf der Stammebene)",
    CARD_MODE: "Kartenmodus",
    CARD_MODE_QA: "Frage & Antwort",
    CARD_MODE_VISUAL: "Visuell (verwendet Überschriften als Fragen)",
    CARD_MODE_CLOZE: "Lückentext (verwendet Hervorhebungen)",
    CARD_MODE_ALL: "Alle",
    ...
    TAG: "Tag",
    TAG_DESC: "Der Tag, der diese Regel auslöst, z.B. #karten.",
    FLASHCARD_: "LERNKARTE_",
    HIDE_REVIEW_BUTTONS: "WIEDERHOLUNGSKNÖPFE AUSBLENDEN",
    NOTE_IN_IGNORED_TAGS: "Notiz befindet sich in ignorierten Tags (Einstellungen prüfen).",
    REVIEW_BUTTON_TOOLTIP: "Tooltip für Wiederholungsknopf",
    REVIEW_BUTTON_TOOLTIP_WITH_INTERVAL: "Tooltip für Wiederholungsknopf mit Intervall",
